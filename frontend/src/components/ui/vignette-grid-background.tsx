...
export function GridVignetteBackground({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-0 z-0 opacity-50 bg-[image:linear-gradient(to_right,var(--muted-foreground),transparent_1px),linear-gradient(to_bottom,var(--muted-foreground),transparent_1px)]",
        className
      )}
      style={{
