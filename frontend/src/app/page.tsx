  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="relative z-10">
        {/* Hero Section */}
        <section className="relative min-h-[calc(100svh-5rem)] flex items-center pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center z-10 w-full">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-to-br from-primary to-secondary text-primary-foreground px-8 py-6 rounded-full font-bold text-lg hover:shadow-xl hover:shadow-primary/20 transition-all" asChild>
                  <Link href="/triage">Start Voice Triage</Link>
                </Button>
                <Button variant="outline" size="lg" className="w-full sm:w-auto border-primary/20 bg-primary/5 text-primary px-8 py-6 rounded-full font-bold text-lg hover:bg-primary/10 transition-all">
                  Watch Video
                </Button>
              </div>
            </div>
            ...
            <div className="relative flex justify-center items-center">
              <div className="voice-orb w-[240px] h-[240px] sm:w-[300px] sm:h-[300px] md:w-[500px] md:h-[500px] rounded-full flex items-center justify-center relative">
                <div className="absolute inset-0 bg-primary/5 rounded-full animate-pulse"></div>
                <div className="w-52 h-52 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full border border-primary/30 flex items-center justify-center p-4">
        ...
        {/* Stats Bar */}
        <section className="bg-card/30 border-y border-white/5 py-16 px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        {/* Feature Cards */}
        <section className="py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
          <div className="mb-20">
        ...
        {/* How it Works */}
        <section className="diagonal-cut bg-card/20 py-24 sm:py-32 lg:py-40 px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="flex gap-6 overflow-x-auto pb-12 scrollbar-hide snap-x px-1 sm:px-4">
            {[
              { 
              ...
              <div key={idx} className="min-w-[280px] sm:min-w-[340px] lg:min-w-[400px] snap-center glass-card p-6 sm:p-8 rounded-3xl flex flex-col justify-between">
        ...
        <section className="py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto glass-card rounded-3xl p-8 sm:p-10 md:p-24 text-center relative overflow-hidden group">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-headline font-bold mb-8 leading-tight">Experience the Future of Triage</h2>
            <p className="text-muted-foreground text-base sm:text-lg md:text-xl mb-12 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-br from-primary to-secondary text-primary-foreground px-10 py-7 rounded-full font-bold text-lg sm:text-xl hover:shadow-2xl hover:shadow-primary/30 transition-all scale-100 hover:scale-105 active:scale-95" asChild>
                <Link href="/triage">Start Triage</Link>
              </Button>
              <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/10 bg-card/40 px-10 py-7 rounded-full font-bold text-lg sm:text-xl hover:bg-card/60 transition-all">
                Talk to Sales
              </Button>
            </div>
          </div>
