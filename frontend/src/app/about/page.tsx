      ...
      <main className="relative pt-28 sm:pt-32 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-5 overflow-hidden">
          <div className="absolute top-[10%] left-[5%] animate-pulse">
            <BrainCircuit className="text-primary w-[180px] h-[180px] sm:w-[240px] sm:h-[240px] lg:w-[300px] lg:h-[300px]" />
          </div>
          <div className="absolute top-[40%] right-[10%] blur-sm">
            <Globe className="text-secondary w-[160px] h-[160px] sm:w-[210px] sm:h-[210px] lg:w-[250px] lg:h-[250px]" />
          </div>
        </div>

        {/* Hero: The Mission */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-24 sm:mb-32">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-end">
            <div className="md:col-span-8">
              <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-6 sm:mb-8 leading-tight">
                The Mission
              </h1>
        ...
        {/* Badge Section */}
        <section className="w-full bg-white/5 py-24 sm:py-32 diagonal-cut relative z-10 my-16 sm:my-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
            <div className="inline-block relative group">
              ...
              <div className="relative glass-card border border-primary/20 p-8 sm:p-12 md:p-20 rounded-[2rem] sm:rounded-full flex flex-col items-center">
                <Terminal className="text-primary w-12 h-12 mb-6" />
                <h2 className="font-headline text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tighter">
        ...
        {/* Tech Stack Section */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 relative z-10">
          <h3 className="font-headline text-2xl sm:text-3xl md:text-4xl font-bold mb-10 sm:mb-16 flex items-center gap-4">
        ...
        <section className="py-24 sm:py-32 relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
              <div>
                <h3 className="font-headline text-2xl sm:text-3xl md:text-4xl font-bold mb-4">The Vanguard Team</h3>
