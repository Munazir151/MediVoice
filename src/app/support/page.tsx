    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20">
        ...
        <section className="relative pt-24 pb-32 px-8 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row gap-12 items-end">
            <div className="md:w-3/5 w-full">
              ...
              <div className="relative group max-w-2xl">
                <Input 
                  className="w-full bg-white/10 backdrop-blur-xl border-none rounded-full px-8 py-8 text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/50 transition-all text-lg shadow-2xl" 
                  placeholder="Search documentation, triage codes, or help articles..." 
                />
                <button className="absolute right-3 top-1/2 -translate-y-1/2 bg-gradient-to-br from-primary to-secondary text-primary-foreground w-12 h-12 rounded-full flex items-center justify-center hover:shadow-[0_0_20px_rgba(87,241,219,0.4)] transition-all">
                  <Search className="w-5 h-5" />
                </button>
              </div>
            </div>
            <div className="md:w-2/5 flex flex-col items-end text-right">
        ...
        {/* Category Bento Grid */}
        <section className="max-w-7xl mx-auto px-8 -mt-16 mb-24 relative z-20">
        ...
        <section className="max-w-7xl mx-auto px-8 mb-32">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="flex-1">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="group flex items-center gap-6 p-6 rounded-3xl glass-card border-white/5 hover:border-primary/30 transition-all cursor-pointer">
            ...
            <div className="lg:w-[400px]">
              <div className="glass-card rounded-[2.5rem] p-10 relative overflow-hidden flex flex-col items-center text-center">
                ...
                <div className="relative mb-12">
                  ...
                  <button className="relative w-32 h-32 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center shadow-2xl transition-transform hover:scale-105 active:scale-95 group">
                    <Mic className="text-primary-foreground w-12 h-12" />
                  </button>
                </div>
